...
const Leaderboard = () => {
  const [teams] = useState([
    ...
    { rank: 2, name: "Neural Ninjas", points: 2720, trend: "down", accuracy: 97.8 },
    { rank: 3, name: "ML Masters", points: 2695, trend: "up", accuracy: 96.9 },
    { rank: 4, name: "PyTorch Pioneers", points: 2580, trend: "up", accuracy: 95.7 },
    { rank: 5, name: "TensorFlow Tigers", points: 2495, trend: "down", accuracy: 94.8 }
  ]);
        ...
        <div className="rounded-lg overflow-hidden border border-slate-700 bg-slate-900/50 backdrop-blur-sm shadow-xl">
          <table className="w-full">
            <thead className="bg-gradient-to-r from-slate-800 to-slate-700 text-slate-300">
              <tr>
                <th className="py-4 px-6 text-left text-sm font-medium">Rank</th>
                <th className="py-4 px-6 text-left text-sm font-medium">Team</th>
                <th className="py-4 px-6 text-right text-sm font-medium">Accuracy</th>
                <th className="py-4 px-6 text-right text-sm font-medium">Points</th>
                <th className="py-4 px-6 text-center text-sm font-medium">Trend</th>
              </tr>
            </thead>
              ...
              {teams.map((team) => (
                <tr
                  ...
                  className={`border-t border-slate-700 ${
                    team.rank === 1 ? 'bg-gradient-to-r from-blue-900 via-blue-700 to-blue-800' : 'hover:bg-slate-700/30'
                ...
                >
                  ...
                  <td className="py-4 px-6 font-semibold text-white">{team.name}</td>
                  <td className="py-4 px-6 text-right text-sm">{team.accuracy}%</td>
                  ...
                  <td className="py-4 px-6 text-center">
                    <TrendingUp
                      className={`inline-block w-6 h-6 ${
                        team.trend === 'up' ? 'text-green-400 rotate-0' : 'text-red-400 rotate-180'
